...
mock:
	...
	mockgen -source=./utils/clients/coingecko_assets/client.go -destination=utils/clients/coingecko_assets/mock/mock.go -package=mock_coingecko_assets
...
instrumented:
	...
	gowrap gen -p github.com/brave-intl/bat-go/utils/clients/coingecko_assets -i Client -t ./.prom-gowrap.tmpl -o ./utils/clients/coingecko_assets/instrumented_client.go
