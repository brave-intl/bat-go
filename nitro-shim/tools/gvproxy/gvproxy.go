// The code below is taken (almost) verbatim from here:
// https://github.com/containers/gvisor-tap-vsock/blob/a39274e8244767c19c74fa68e9d1d8316cf9e175/cmd/gvproxy/main.go
// The only modification we made was to remove the forward-SSH-by-default rule.
//
// In the above revision, gvisor-tap-vsock is licensed under the Apache 2.0
// license, which permits us to use the code here.
package main
