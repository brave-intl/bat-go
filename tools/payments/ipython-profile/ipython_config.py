...
"%alias status dist/status -e $$environment -p $$payout_id -rp $$redis_password -ru $$redis_username",
"%alias authorize dist/authorize -e $$environment -p $$payout_id -k $$operator_key -ru $$redis_username -rp $$redis_password -pr $$payout_report -pcr2 $$pcr2 $$prepare_log",
"%alias bootstrap dist/bootstrap -b $$secrets_s3_bucket -v -e $$environment -p $$operator_key -pcr2 $$pcr2 %s",
"%alias prepare dist/prepare -e $$environment -p $$payout_id -ru $$redis_username -rp $$redis_password -pcr2 $$pcr2 $$payout_report",
"%alias report dist/report -e $$environment -p $$payout_id -ru $$redis_username -rp $$redis_password -pcr2 $$pcr2 $$payout_report",
"%alias info dist/info -e $$environment -pcr2 $$pcr2 $$payout_report",
"%alias await_prepare touch $$prepare_log && dist/prepare -cg cli2 -e $$environment -p $$payout_id -ru $$redis_username -rp $$redis_password -pcr2 $$pcr2 $$payout_report",
"%alias redis redis-cli -p 6380 --user $$redis_username --pass $$redis_password",
"%alias flush_redis redis-cli -p 6380 --user $$redis_username --pass $$redis_password del \*$$payout_id\*",
"%alias list_payouts redis-cli -p 6380 --user $$redis_username --pass $$redis_password keys \*",
"%alias worker_logs AWS_VAULT= kubectl --context $$cluster --namespace payment-$$environment logs deployments/worker",
"%alias enclave_logs AWS_VAULT= kubectl --context $$cluster --namespace payment-$$environment logs deployments/web -c nitro-utils",
"%alias pods AWS_VAULT= kubectl --context $$cluster --namespace payment-$$environment get pods",
...
#  Default: "Python 3.11.6 (main, Nov 14 2023, 09:36:21) [GCC 13.2.1 20230801]\nType 'copyright', 'credits' or 'license' for more information\nIPython 8.20.0 -- An enhanced Interactive Python. Type '?' for help.\n"
# c.InteractiveShell.banner1 = "Python 3.11.6 (main, Nov 14 2023, 09:36:21) [GCC 13.2.1 20230801]\nType 'copyright', 'credits' or 'license' for more information\nIPython 8.20.0 -- An enhanced Interactive Python. Type '?' for help.\n"
