...
"%alias redis redis-cli -p 6380 --user $$redis_username",
"%alias flush_redis redis-cli -p 6380 --user $$redis_username del \*$$payout_id\*",
"%alias list_payouts redis-cli -p 6380 --user $$redis_username keys \*",
