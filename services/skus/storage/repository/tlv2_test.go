			...
			given: tcGiven{
				...
				fnBefore: func(ctx context.Context, dbi sqlx.ExtContext) error {
					qs := []string{
						...
						`INSERT INTO time_limited_v2_order_creds (id, issuer_id, order_id, item_id, request_id, valid_to, valid_from, created_at, batch_proof, public_key, blinded_creds, signed_creds)
