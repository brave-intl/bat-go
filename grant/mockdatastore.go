...
// Package mock_grant is a generated GoMock package.
package grant
...
func (mr *MockDatastoreMockRecorder) ClaimPromotionForWallet(promo, wallet interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ClaimPromotionForWallet", reflect.TypeOf((*MockDatastore)(nil).ClaimPromotionForWallet), promo, wallet)
}
